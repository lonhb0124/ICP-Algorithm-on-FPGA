...
def icp(reference_points, points, max_iterations=100, distance_threshold=0.3, convergence_translation_threshold=1e-3,
    ...
    for iter_num in range(max_iterations):
        ...
        if closest_rot_angle is None or closest_translation_x is None or closest_translation_y is None:
            ...
            break
        print("closest_rot_angle: "+str(closest_rot_angle))
        print("closest_translation_x: "+str(closest_translation_x))
        print("closest_translation_y: "+str(closest_translation_y))
...
reference_points = np.loadtxt('reference_points.csv', delimiter=',')
source_points = np.loadtxt('source_points.csv', delimiter=',')

# Now you can access and use the reference_points numpy array
#print(reference_points)
#print(source_points)
print("==================================================================")
transformation_history, source_points = icp(reference_points, source_points)
myobj2 = datetime.now()
end_time = time.process_time() * 1e6

elapsed_time_micro = (end_time - start_time)

print(f"Elapsed time: {elapsed_time_micro:.10f} microseconds")
print("Current microsecond ", myobj.microsecond)
print("Current microsecond ", myobj2.microsecond)
